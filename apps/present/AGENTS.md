...
- `pnpm --filter @tcw/present verify:production-evidence` — Validate production Entra, LiveKit endpoint, browser smoke, and native-picker JSON reports
