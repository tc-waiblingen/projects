    ...
    <div className="mb-6 w-full">
      ...
      >
        <g className="text-muted" stroke="currentColor" strokeWidth="0.75" fill="none" opacity="0.45">
          <polyline points="205,122 240,108 268,108" />
        ...
        <g>
          <path d="M 240 70 L 240 120 L 320 120 Z" fill="rgb(194 65 12 / 0.9)" />
          <path d="M 240 70 L 320 70 L 320 120 Z" fill="rgb(82 82 91 / 0.8)" />
        ...
        <foreignObject x="345" y="75" width="215" height="60">
