...
export function FeatureThreeColumnWithDemos({
  ...
  return (
    <div className={clsx('rounded-lg bg-tcw-accent-900/2.5 p-2 dark:bg-white/5', className)} {...props}>
      ...
      <div className="p-6 sm:p-10 lg:p-6">
        ...
        <div className="mt-2 flex flex-col gap-4 text-sm/7 text-muted">{subheadline}</div>
      </div>
    </div>
  )
}
